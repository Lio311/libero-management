      ...
      <AnimatePresence>
        {showNotifications && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute z-[100] top-full mt-4 left-0 md:left-auto md:right-0 w-[calc(100vw-2rem)] sm:w-80 bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden text-right max-h-[80vh] flex flex-col"
            dir="rtl"
          >
