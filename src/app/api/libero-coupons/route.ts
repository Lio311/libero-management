...
export async function GET(request: Request) {
    ...
    const ck = process.env.LIBERO_WC_CK || 'ck_c551947f6cd4c709b527cab0f18651cf19433b51';
    const cs = process.env.LIBERO_WC_CS || 'cs_c32883b9954569200ebea224812180dad9cc01dc';
