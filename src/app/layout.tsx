  ...
  return (
    <ClerkProvider localization={heIL}>
      <html lang="he" dir="rtl">
        <body 
          className={`${assistant.className} antialiased h-screen overflow-hidden flex flex-col md:flex-row bg-cover bg-center bg-no-repeat bg-fixed bg-white/90 bg-blend-lighten`}
